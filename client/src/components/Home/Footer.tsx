    ...
    return (
        <div className="flex h-72 py-14 px-20 bg-beige">
            <div className="flex flex-col gap-y-3">
                ...
                {/* Non-functional */}
                <div className="font-proxima font-bold text-coffee text-sm"> Request </div>
                <div className="font-proxima font-bold text-coffee text-sm"> Shop </div>
                <div className="font-proxima font-bold text-coffee text-sm"> About </div>
